...
namespace WinFExcel
{
    class FeedData
    {
        public static DataTable FeedDataTable()
        {
            ...
            DtFeed.Rows.Add(new object[] { "Vinicius", 150.30, 2, false, DateTime.Parse("2013-07-04") });
            DtFeed.Rows.Add(new object[] { "Adga", 340.98, 1, false, DateTime.Parse("2008-02-04") });
            DtFeed.Rows.Add(new object[] { "Rian", 50.35, 0, true, DateTime.Parse("2013-10-12") });
